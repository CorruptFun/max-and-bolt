...
(function () {
  ...
  S.push({
    ...
    cover: { bg: "yard", cast: [{ who: "bolt", mood: "surprised", pose: "run", x: 30 }], props: [{ e: "🐕", x: 65, y: 82, s: 70 }, { e: "🛞", x: 60, y: 92, s: 24 }, { e: "🛞", x: 72, y: 92, s: 24 }], fx: "speed" },
    ...
    pages: [
      ...
      { art: { bg: "garage", cast: [{ who: "max", mood: "happy", pose: "point", x: 25 }, { who: "bolt", mood: "love", x: 80, flip: true }], props: [{ e: "🐕", x: 55, y: 80, s: 60 }, { e: "🛞", x: 50, y: 92, s: 22 }, { e: "🛞", x: 62, y: 92, s: 22 }] }, lines: [{ n: "So Max built a robot dog. It had four wheels, a wagging tail, and one job: to fetch. Bolt named it Chomp." }] },
      { art: { bg: "yard", cast: [{ who: "zoe", mood: "mad", pose: "point", x: 30 }], props: [{ e: "🐕", x: 70, y: 82, s: 60 }, { e: "📱", x: 70, y: 66, s: 26 }, { e: "⚽", x: 15, y: 90, s: 26 }, { e: "👟", x: 88, y: 90, s: 26 }] }, lines: [{ n: "Chomp fetched a ball. Then a shoe. Then Zoe's phone, which was a problem." }, { w: "zoe", t: "GIVE THAT BACK!" }] },
      { art: { bg: "yard", cast: [{ who: "max", mood: "think", pose: "think", x: 30 }], props: [{ e: "🐕", x: 65, y: 82, s: 60 }, { e: "🧦", x: 50, y: 60, s: 26 }, { e: "🥄", x: 80, y: 55, s: 26 }, { e: "🧢", x: 88, y: 75, s: 26 }] },
      ...
      { art: { bg: "yard", cast: [{ who: "bolt", mood: "surprised", x: 35 }], props: [{ e: "🐕", x: 75, y: 82, s: 60 }, { e: "👀", x: 75, y: 62, s: 26 }], fx: "sparkle" }, lines: [{ n: "Then Chomp saw Bolt's tail. It was shiny. It was wagging. To Chomp, it looked like a ball." }] },
      { art: { bg: "yard", cast: [{ who: "bolt", mood: "worried", pose: "run", x: 25 }, { who: "max", mood: "surprised", pose: "run", x: 75 }, { who: "zoe", mood: "laugh", pose: "hold", x: 92, scale: .8 }], props: [{ e: "🐕", x: 50, y: 84, s: 56 }, { e: "📱", x: 92, y: 60, s: 20 }], fx: "speed" }, lines: [{ n: "Chomp chased Bolt around the yard six times. Bolt yelled. Max chased Chomp. Zoe filmed it." }] },
      { art: { bg: "yard", cast: [{ who: "cat", mood: "sly", x: 35, y: 92 }], props: [{ e: "🐕", x: 70, y: 82, s: 60 }] }, lines: [{ n: "Mr. Whiskers stopped it. He just sat down in front of Chomp and stared. Chomp stopped." }] },
      { art: { bg: "room", cast: [{ who: "bolt", mood: "sleepy", x: 40 }], props: [{ e: "🐕", x: 72, y: 88, s: 50 }, { e: "💤", x: 80, y: 70, s: 26 }], fx: "dark" }, lines: [{ n: "Bolt hid his tail for a week." }, { w: "bolt", t: "I do not want a pet." }, { n: "Chomp sleeps by his bed now." }] },
    ],
    quiz: [
